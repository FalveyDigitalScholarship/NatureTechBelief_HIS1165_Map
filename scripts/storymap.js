 ...
 var opacity = (c['Overlay Transparency'] !== '') ? parseFloat(c['Overlay Transparency']) : 1;
    ...
    $('#contents').append(" \
      <div id='space-at-the-bottom'> \
        ...
        <br/> \
        <a href='mailto:megan.piorko@villanova.edu'>  \
          <small>Contact Meg Piorko</small>  \
        </a> \
      </div> \
    ");
    ...
    $("<style>")
      ...
      .html("\
      #narration, #title {\
        background-color: " + trySetting('_narrativeBackground', 'black') + "; \
        color: " + trySetting('_narrativeText', 'black') + "; \
      }\
      a, a:visited, a:hover {\
        color: " + trySetting('_narrativeLink', 'black') + " \
      }\
      .in-focus {\
        background-color: " + trySetting('_narrativeActive', 'white') + " \
      }")
      .appendTo("head");
